...
It is quite simple. Before version 9217, the SSL system module does not validate the certificates' signature when validating a certificate chain. Consequently, anyone can generate a private/public key pair and create its own CA certificate from already existing ones.
